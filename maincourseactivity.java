...
public class maincourseactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maincourseactivity);

        ListView Maincourselist = findViewById(R.id.listview_maincourses);
        ...
        ArrayAdapter<Dish> maincourseadapter= new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,maincourses);
